...
public class PlacesTest {
    ...
    public void testLongitudeParsing(String longitude, String latitude, Boolean expected) {
        Places earth = new Places("000000", "", "", null, null, "0", null, JoinTableNames.Supername);
        Places places = new Places("123456", "", "", longitude, latitude, "0", Arrays.asList("000000"), JoinTableNames.Country);
